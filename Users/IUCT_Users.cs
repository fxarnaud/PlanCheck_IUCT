...
namespace PlanCheck_IUCT.Users
{
    public class IUCT_Users
    {
        ...
        public IUCT_Users()
        {
            ...
            IUCT_User cavet = new IUCT_User() { UserFirstName = "Clémence", UserFamilyName = "Cavet", Gender = "F", Function = "Dosimetriste", UserBackgroundColor = System.Windows.Media.Brushes.Red, UserForeGroundColor = System.Windows.Media.Brushes.White };
            ...
            IUCT_User graulieres = new IUCT_User() { UserFirstName = "Eliane", UserFamilyName = "Graulieres", Gender = "F", Function = "Physicien", UserBackgroundColor = System.Windows.Media.Brushes.DeepPink, UserForeGroundColor = System.Windows.Media.Brushes.White };
            ...
            IUCT_User brun = new IUCT_User() { UserFirstName = "Thomas", UserFamilyName = "Brun", Gender = "H", Function = "Physicien", UserBackgroundColor = System.Windows.Media.Brushes.RosyBrown, UserForeGroundColor = System.Windows.Media.Brushes.White };
            ...
            IUCT_User stadler = new IUCT_User() { UserFirstName = "Marine", UserFamilyName = "Stadler", Gender = "F", Function = "Physicien", UserBackgroundColor = System.Windows.Media.Brushes.Aquamarine, UserForeGroundColor = System.Windows.Media.Brushes.White };
            _users_list.Add(stadler);

            IUCT_User tournier = new IUCT_User() { UserFirstName = "Aurélie", UserFamilyName = "Tournier", Gender = "F", Function = "Physicien", UserBackgroundColor = System.Windows.Media.Brushes.DarkTurquoise, UserForeGroundColor = System.Windows.Media.Brushes.White };
            ...
            IUCT_User couarde = new IUCT_User() { UserFirstName = "Laetitia", UserFamilyName = "Couarde", Gender = "F", Function = "Radiothérapeute", UserBackgroundColor = System.Windows.Media.Brushes.DeepPink, UserForeGroundColor = System.Windows.Media.Brushes.White };
            ...
            IUCT_User massabeau = new IUCT_User() { UserFirstName = "Carole", UserFamilyName = "Massabeau", Gender = "F", Function = "Radiothérapeute", UserBackgroundColor = System.Windows.Media.Brushes.BlueViolet, UserForeGroundColor = System.Windows.Media.Brushes.White };
            _users_list.Add(massabeau);

            IUCT_User modesto = new IUCT_User() { UserFirstName = "Anouchka", UserFamilyName = "Modesto", Gender = "F", Function = "Radiothérapeute", UserBackgroundColor = System.Windows.Media.Brushes.GreenYellow, UserForeGroundColor = System.Windows.Media.Brushes.White };
            _users_list.Add(modesto);

            IUCT_User moyal = new IUCT_User() { UserFirstName = "Elizabeth", UserFamilyName = "Moyal", Gender = "F", Function = "Radiothérapeute", UserBackgroundColor = System.Windows.Media.Brushes.Red, UserForeGroundColor = System.Windows.Media.Brushes.White };
            _users_list.Add(moyal);

            IUCT_User piram = new IUCT_User() { UserFirstName = "Lucie", UserFamilyName = "Piram", Gender = "F", Function = "Radiothérapeute", UserBackgroundColor = System.Windows.Media.Brushes.LightBlue, UserForeGroundColor = System.Windows.Media.Brushes.White };
            ...
            IUCT_User preault = new IUCT_User() { UserFirstName = "Mickael", UserFamilyName = "Preault", Gender = "H", Function = "Radiothérapeute", UserBackgroundColor = System.Windows.Media.Brushes.Azure, UserForeGroundColor = System.Windows.Media.Brushes.White };
